...
onMounted(async () => {
  if (isEdit && postId) {
    ...
    if (!post) { router.replace('/community/posts'); return }
    if (post.userId !== auth.user?.userId) { router.replace('/community/posts'); return }
    ...
    <div class="container container-narrow">
      ...
      <div class="write-form">
        ...
        <div class="write-actions">
          <button class="btn btn-ghost" @click="router.push('/community/posts')">취소</button>
