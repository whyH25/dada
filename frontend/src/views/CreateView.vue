...
async function gotoStep2() {
  ...
  try {
    ...
    flow.currentRoomId = result.roomId
    step.value = 2
    window.scrollTo(0, 0)
  } catch (e) {
        ...
        <div class="check-layout">
              ...
              <div class="form-section-body" style="padding-bottom: 22px;">
                ...
                <div class="check-list">
                  <div class="check-item">
                    ...
                    <div class="check-item-body"><div class="check-item-title">카메라</div><div class="check-item-sub">1280 × 720 · 30 fps</div></div>
                    <span class="check-item-status"><span class="badge-dot" style="background: var(--green-500)"></span>정상</span>
                  </div>
                  <div class="check-item">
                    <div class="check-item-icon"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M20 6 9 17l-5-5" /></svg></div>
                    <div class="check-item-body"><div class="check-item-title">마이크</div><div class="check-item-sub">입력 레벨: <span style="color: var(--green-500)">●●●●●●●●</span><span style="color: var(--ink-300)">○○</span></div></div>
                    <span class="check-item-status"><span class="badge-dot" style="background: var(--green-500)"></span>정상</span>
                  </div>
                  <div class="check-item">
                    <div class="check-item-icon"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M20 6 9 17l-5-5" /></svg></div>
                    <div class="check-item-body"><div class="check-item-title">스피커</div><div class="check-item-sub">테스트 사운드를 재생해보세요</div></div>
                    <button class="btn btn-sm btn-secondary">테스트</button>
                  </div>
                  <div class="check-item">
                    <div class="check-item-icon"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M20 6 9 17l-5-5" /></svg></div>
                    <div class="check-item-body"><div class="check-item-title">네트워크</div><div class="check-item-sub">상향 38 Mbps · 하향 124 Mbps · Ping 12ms</div></div>
                    <span class="check-item-status"><span class="badge-dot" style="background: var(--green-500)"></span>정상</span>
                  </div>
                </div>
              </div>
          ...
          <aside class="preview-panel">
            ...
            <div class="preview-body">
              ...
              <div class="preview-row">
                <div class="preview-row-label">제출 서류</div>
                <div class="preview-row-val">{{ submittedDocCount === 0 ? '없음' : submittedDocCount + '건' }}</div>
              </div>
              <div class="preview-row"><div class="preview-row-label">예상 소요 시간</div><div class="preview-row-val">{{ estimatedTime }}</div></div>
            </div>
            <div class="preview-foot">
              <button class="btn btn-primary btn-block btn-lg" @click="startInterview">면접방 생성하고 시작하기</button>
