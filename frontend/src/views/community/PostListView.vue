...
function goWrite() {
  ...
  if (!auth.isLoggedIn) {
    auth.openLogin(() => router.push({ path: '/community/posts/new', query: { category: cat } }))
    return
  }
  router.push({ path: '/community/posts/new', query: { category: cat } })
}
  ...
  <div class="comm-panel">
    ...
    <div v-else class="board-list">
      <div
        ...
        class="board-item"
        @click="router.push('/community/posts/' + p.postId)"
      >
        <div class="bi-main">
