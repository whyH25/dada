    ...
    <div class="container container-narrow">
      ...
      <div class="page-header" style="border-bottom:none;padding-bottom:8px;margin-bottom:8px;">
        <div class="breadcrumb">
          ...
          <a @click="router.push('/community/posts')" style="cursor:pointer;">커뮤니티</a>
      ...
      <div v-else-if="notFound" class="pd-not-found">
        ...
        <button class="btn btn-ghost" @click="router.push('/community/posts')">목록으로</button>
      </div>
      ...
      <template v-else>
        ...
        <div class="pd-head">
          ...
          <div class="pd-meta-row">
            ...
            <div v-if="isOwner()" class="pd-owner-actions">
              <button class="pd-action-btn" @click="router.push('/community/posts/' + postId + '/edit')">수정</button>
        ...
        <div class="pd-actions">
          <button class="btn btn-secondary" @click="router.push('/community/posts')">목록으로 →</button>
        </div>
