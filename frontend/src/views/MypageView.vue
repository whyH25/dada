...
// ---- 서류 관리 ----
const docMeta = {
  resume: { title: '이력서', accept: '.pdf,.doc,.docx', hint: 'PDF · DOC · 최대 10MB' },
  cover: { title: '자기소개서', accept: '.pdf,.doc,.docx', hint: 'PDF · DOC · 최대 10MB' },
  portfolio: { title: '포트폴리오', accept: '.pdf,.zip', hint: 'PDF · ZIP · URL · 최대 50MB' },
}
const docs = reactive({
  resume: [{ name: '이력서_김지원_v4.pdf', size: '324 KB', date: '26.05.20', main: true }],
  cover: [{ name: '자기소개서_카카오_백엔드.pdf', size: '210 KB', date: '26.05.19', main: false }, { name: '자기소개서_공통_v2.docx', size: '188 KB', date: '26.05.10', main: false }],
    ...
    <div class="container">
      <div class="mypage">
        ...
        <aside class="side-menu">
          ...
          <div class="side-section">
            ...
            <div class="side-item" :class="{ active: section === 'resume' }" @click="gotoMy('resume')">
              ...
              이력서 <span class="count">{{ sideDocCount('resume') }}</span>
            </div>
            <div class="side-item" :class="{ active: section === 'cover' }" @click="gotoMy('cover')">
              ...
              자기소개서 <span class="count">{{ sideDocCount('cover') }}</span>
            </div>
        ...
        <div id="mypage-content">
          ...
          <!-- 서류 관리 -->
          <template v-else-if="['resume', 'cover', 'portfolio'].includes(section)">
